...
function jugar(usuario, maquina) {
  ...
  switch(opcionUsuario)
  {
    ...
    case 'tijera': document.getElementById("usuario").innerHTML = "<img src='img/tijera.png'/>"; procesar(maquina, 2); break;
    case 'lagarto': document.getElementById("usuario").innerHTML = "<img src='img/lagarto.png'/>"; procesar(maquina, 3); break;
    case 'spock': document.getElementById("usuario").innerHTML = "<img src='img/spock.png'/>"; procesar(maquina, 4); break;
  }
}
...
function procesar(opcionMaquina, opcionUsuario) {
  ...
  switch(opcionMaquina)
  {
    ...
    case 2: document.getElementById("maquina").innerHTML = "<img  src='img/tijera.png'/>"; break;
    case 3: document.getElementById("maquina").innerHTML = "<img  src='img/lagarto.png'/>"; break;
    case 4: document.getElementById("maquina").innerHTML = "<img  src='img/spock.png'/>"; break; 
  }
